...
function updateNavAnimation(activeView) {
    ...
    if (indicator && btn && nav) {
        ...
        indicator.style.transform = `translateX(${offset + 8}px)`; 
...
function drawCanvas() {
    ...
    drawCanvasTimer = setTimeout(() => {
        ...
        if (currentTextAlign === 'left') x = 40;
        if (currentTextAlign === 'right') x = canvas.width - 40;
